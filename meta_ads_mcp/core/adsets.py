...
async def get_adset_details(access_token: str = None, adset_id: str = None) -> str:
    ...
    - Targeting & Attribution: targeting, attribution_spec, frequency_control_specs
